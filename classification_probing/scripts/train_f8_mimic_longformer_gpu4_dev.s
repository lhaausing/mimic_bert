...
echo "model: ${model_name}, batch_size: ${batch_size}, seed: ${seed}, freeze :${layer}, finally change to BertTokenizer.from_pretrained(mimic_tokenizer)
"
