...
if __name__ == "__main__":
    ...
    '--output_dir', 'Clinical-longformer-pretrain-evalonbase',
    '--warmup_steps', '500',
...
##################### use pretrianed longformer in transformer
    ...
    pretrain_and_evaluate(training_args, longformer_model, longformer_tokenizer, eval_only=True, model_path=None\
