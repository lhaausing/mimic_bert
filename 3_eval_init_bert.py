...
if __name__ == "__main__":
    ...
    '--output_dir', '/gpfs/scratch/xl3119/capstone/checkpoints/bert_mimic_tokenizer_gpu4_short/checkpoint-16000',
    '--warmup_steps', '250',
    '--learning_rate', '1e-4',
    '--weight_decay', '0.01',
    '--adam_epsilon', '1e-6',
...
##################### use pretrianed longformer in transformer
    ...
    bert_model = BertForMaskedLM.from_pretrained(training_args.output_dir)
    #bert_model = use_embeddings_fasttext(bert_model, word_embeddings)
    # longformer_tokenizer = LongformerTokenizer.from_pretrained('allenai/longformer-base-4096')

    logger.info('Evaluate BERT-base model with mimic tokenizer...')
    pretrain_and_evaluate(training_args, bert_model, mimic_tokenizer, train_only=False, eval_only=True, model_path=None
